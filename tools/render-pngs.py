...
# Not only render 24x4 PNGs
		...
		rc = os.system('inkscape --export-type=png -w 64 -h 64 --export-id="%s" --export-filename="pngs/64/%s" "%s"' % (self.name, sliceFName, svgFName))
		rc = os.system('inkscape --export-type=png -w 96 -h 96 --export-id="%s" --export-filename="pngs/96/%s" "%s"' % (self.name, sliceFName, svgFName))
